...
public class C2_MethodCreation2 {
   ...
   public static void dortSayiTopla() {   
	   Scanner scan = new Scanner(System.in);
       System.out.println("Lutfen toplamak istediginiz 4 sayiyi giriniz");
   ...
   public static void ucSayiTopla() {   
	   Scanner scan = new Scanner(System.in);
       System.out.println("Lutfen toplamak istediginiz 3 sayiyi giriniz");
       int sayi1 = scan.nextInt();
       int sayi2 = scan.nextInt();
       int sayi3 = scan.nextInt();
   ...
   public static void ikiSayiTopla() {
	   Scanner scan = new Scanner(System.in);
       System.out.println("Lutfen toplamak istediginiz 2 sayiyi giriniz");
       int sayi1 = scan.nextInt();
       int sayi2 = scan.nextInt();
